        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="./customer.php?id=<?=$customer['customer_id']?>" class="btn btn-danger">Delete</a>
                <a href="./customer-update.php?id=<?=$customer['customer_id']?>" class="btn btn-primary">Update</a>
              </td>
